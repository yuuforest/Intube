...
public class JwtAuthenticationFilter extends BasicAuthenticationFilter {
    ...
    public JwtAuthenticationFilter(AuthenticationManager authenticationManager, UserRepository userRepository, AuthService authService) {
        ...
        if (token != null) {
            ...
            if (email != null) {
                ...
                if (user != null) {
                    ...
                    if (authService.hasAuthKey(email + "-BlackList")) {
                        // BlackList에 있으면 이미 만료된 token
                        throw new TokenExpiredException("You need to login!");
                    }
