...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/user/image").authenticated()
                .antMatchers("/api/user/interviewer/**").authenticated()
                .antMatchers("/api/user/interviewee/mypage").authenticated()
                .antMatchers("/api/user/interviewer").authenticated()
                .antMatchers("/api/user/interviewee").authenticated()
                .antMatchers("/api/interviews/apply/**").authenticated()
                .antMatchers("/api/interviews/cancel/**").authenticated()
                .antMatchers(HttpMethod.GET, "/api/interviews/search/{interview_id}").authenticated()
                .antMatchers(HttpMethod.PUT, "/api/user").authenticated()
                .antMatchers("/api/conference").authenticated()
                .antMatchers(HttpMethod.PUT, "/api/user/password").authenticated()
                .antMatchers(HttpMethod.POST, "/api/interviews").authenticated()
                .antMatchers(HttpMethod.POST, "/api/auth/check-password").authenticated()
                .antMatchers(HttpMethod.DELETE, "/api/auth/logout").authenticated()
                .antMatchers(HttpMethod.DELETE, "/api/user").authenticated()
                .antMatchers("/api/auth").permitAll()
                .antMatchers(HttpMethod.POST, "/api/user").permitAll()
                .antMatchers("/api/user/nickname", "/api/user/find-email", "/api/user/find-password").permitAll()
